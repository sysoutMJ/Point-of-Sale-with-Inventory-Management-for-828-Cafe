package cafe828.desktop.notification;
...
public class ShowNotifiactionView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ImageView imageView = new ImageView(new Image(getClass().getResourceAsStream("cafe828/desktop/images/topmenubar/Notifications.png")));
        ...
        notificationToggleButton.getStylesheets().add(getClass().getResource("src/top-menu-buttons.css").toExternalForm());
