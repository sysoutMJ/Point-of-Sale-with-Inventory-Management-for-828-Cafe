package cafe828.desktop.maintenance.restock;
...
//    }
	...
	private void showItemFoundDialog() {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/cafe828/desktop/maintenance/restock/dialogueboxes/ItemFoundView.fxml"));
			Parent root = loader.load();
	...
	private void showItemSuccessfullyRestocked() {
		try {
			FXMLLoader loader = new FXMLLoader(getClass()
					.getResource("/cafe828/desktop/maintenance/restock/dialogueboxes/ItemSuccessfullyRestockedView.fxml"));
			Parent root = loader.load();
	...
	private void showNegativeValueNotAllowed() {
		try {
			FXMLLoader loader = new FXMLLoader(getClass()
					.getResource("/cafe828/desktop/maintenance/restock/dialogueboxes/NegativeValueNotAllowed.fxml"));
			Parent root = loader.load();
	...
	private void showConfirmRestockItemDialog() {
	    try {
	        FXMLLoader loader = new FXMLLoader(getClass().getResource("/cafe828/desktop/maintenance/restock/dialogueboxes/ConfirmRestockItemView.fxml"));
	        Parent root = loader.load();
